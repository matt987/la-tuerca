...
namespace LaTuerca.Controllers
{
    public class InvoiceDetailsController : Controller
    {
        ...
        {
            var invoiceDetails = db.InvoiceDetails.Include(i => i.Invoice).Include(i => i.Repuesto);
        ...
        public ActionResult Create([Bind(Include = "Id,Cantidad,Precio,InvoiceId,RepuestoId")] InvoiceDetail invoiceDetail)
        {
            ...
            ViewBag.RepuestoId = new SelectList(db.Repuestoes, "Id", "Nombre", invoiceDetail.RepuestoId);
            return View(invoiceDetail);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Cantidad,Precio,InvoiceId,RepuestoId")] InvoiceDetail invoiceDetail)
        {
            if (ModelState.IsValid)
            {
